<?php
/**
 * chanceforfun theme setup and assets.
 */
...
add_action('after_setup_theme', function () {
    ...
    register_nav_menus([
        'primary' => __('Primary Menu', 'chanceforfun'),
    ]);
});
